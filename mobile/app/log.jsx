...
const s = StyleSheet.create({
  ...
  errorBox:           { backgroundColor: '#3f0000', borderWidth: StyleSheet.hairlineWidth, borderRadius: 6, paddingHorizontal: 16, paddingVertical: 12, marginBottom: 16, borderColor: '#dc2626' },
  ...
  searchInput:        {
    flex: 1, borderWidth: StyleSheet.hairlineWidth, borderRadius: 6, paddingHorizontal: 16, paddingVertical: 12, fontSize: 14,
  ...
  typeBadge:          { borderWidth: StyleSheet.hairlineWidth, borderRadius: 4, paddingHorizontal: 6, paddingVertical: 2, alignSelf: 'flex-start', marginTop: 6 },
  typeText:           { fontSize: 11, fontWeight: '700' },
  changeBtn:          { fontSize: 12, marginTop: 6 },
  formFields:         { gap: 20 },
  dateBtn:            {
    borderWidth: StyleSheet.hairlineWidth, borderRadius: 6, paddingHorizontal: 16, paddingVertical: 12,
    shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 8, elevation: 2,
  },
  dateBtnText:        { fontSize: 14 },
  doneBtn:            { fontSize: 13, textAlign: 'right', marginTop: 8 },
  notesInput:         {
    borderWidth: StyleSheet.hairlineWidth, borderRadius: 6, paddingHorizontal: 16, paddingVertical: 12, fontSize: 14, minHeight: 80,
    shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.08, shadowRadius: 8, elevation: 2,
  },
  ...
  cancelBtn:          { paddingHorizontal: 20, paddingVertical: 14, borderRadius: 6, borderWidth: StyleSheet.hairlineWidth },
